export type TeamMemberAdded = {
  name: string;
  workspaceId: string;
  teamId: string;
};

export const teamMemberAddedSubject = "You've been added to a team - Opsignal";

function teamMemberAddedEmail({ name, workspaceId, teamId }: TeamMemberAdded) {
                ...
                <table role="presentation" style="max-width: 560px; width: 100%; border-collapse: collapse; background: #ffffff; border-radius: 12px; box-shadow: 0 4px 24px rgba(0, 0, 0, 0.08); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 48px 48px 32px; text-align: center;">
                            <h1 style="margin: 0 0 12px; color: #1d1d1f; font-size: 28px; font-weight: 600; letter-spacing: -0.5px;">Welcome to the team!</h1>
                            <p style="margin: 0; color: #86868b; font-size: 16px; line-height: 1.5;">You've been added as a team member</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 48px 48px;">
                            ...
                            <p style="margin: 0 0 32px; color: #1d1d1f; font-size: 15px; line-height: 1.6;">
                                You've been added to a team on Opsignal. You can now access the workspace and start collaborating with your team members.
                            </p>
                            ...
                            <p style="margin: 0; color: #86868b; font-size: 13px; line-height: 1.5;">
                                If you have any questions, feel free to reach out to your team lead.
                            </p>
