...
import { addTeamMemberService } from "../service/addTeamMember.service.js";
import { addTeamMemberSchema } from "../validation/addTeamMember.validation.js";

/**
 * Controller for adding team members
 */
export async function addTeamMemberController(
  ...
  try {
    ...
    const { email, teamId } = validationResult.data;
    ...
    if (error instanceof Error) {
      ...
      if (
        ...
        error.message.includes("own team")
      ) {
